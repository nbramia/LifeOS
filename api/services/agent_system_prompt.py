...
TASK_HIERARCHY_INSTRUCTION = (
    ...
    "provider unless the operator explicitly delegated that choice. A project child "
    "you create or update never carries #hermes — the operator assigns that from the "
    "board — and a paid route (#cloud/#cloud-haiku/#cloud-sonnet) is refused unless "
    "the project's own owner already carries that same route. Completing a "
