...
The specialized personas (`fitness`, `therapist`, `doctor`, `finance`) are bound to Telegram bots in `config/telegram_bots.json`; `primary` is the default and needs no binding.
